defmodule FinalProject.AuthTest do
  ...
  describe "users" do
    ...
    import FinalProject.AuthFixtures
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{email: "some email", is_admin: true, password: "some password", username: "some username"}
